...
I wanted something that looked as good as the stock widgets on mobile phones—dark mode, smooth gradients, and easy to read—but right on my Linux desktop. It pulls data directly from Yahoo Finance, so you get coverage for stocks and crypto from all over the world.
<p align="center">
